...
제네릭 함수는 아래와 같이 `한 개 이상의 타입 매개변수를 갖는 함수`입니다.
...
List, Map 과 같은 자료구조는 제네릭 타입으로 되어있습니다. (e.g List<T>, Map<T>)
...
> 💡 T가 타입 매개변수일때, 함수 안에서 T 타입의 부품은 아무 능력도 요구되지 않는 곳에서만 사용해야된다.

> T가 어떤 방식으로 사용될지는 아무도 모르기 때문입니다. 또는 특정 타입을 요구해야된다면 타입 좁히기를 통해 능력을 제한할 수 있습니다.
